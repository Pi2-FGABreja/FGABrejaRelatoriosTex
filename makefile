...
do: *.tex
	...
	then \
		...
		grep -v "\%" *.tex conteudo/*.tex > search.temp;\
...
clean:
	rm -rf *.aux *.log *.toc *.bbl *.bak *.blg *.out *.lof *.lot *.lol *.glg *.glo *.ist *.xdy *.gls *.acn *.idx *.acr *.alg
	cd conteudo; rm -rf *.aux *.log *.toc *.bbl *.bak *.blg *.out *.lof *.lot *.lol *.glg *.glo *.ist *.xdy *.gls *.acn *.idx *.acr *.alg
